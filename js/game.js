...
function createScene() {
  ...
  scene.fog = new THREE.Fog(0x57175f, 0,950);
  camera.position.x = 0;
...
function createLights() {
  ...
  hemisphereLight = new THREE.HemisphereLight(0x8288ff,0x1d27f6, 1)

  ambientLight = new THREE.AmbientLight(0x8288ff, 1);
...
var AirPlane = function(){
  ...
  var matCockpit = new THREE.MeshPhongMaterial({color:0xfada00, shading:THREE.FlatShading});
  ...
  var matTailPlane = new THREE.MeshPhongMaterial({color:0xfada00, shading:THREE.FlatShading});
  ...
  var matTube = new THREE.MeshPhongMaterial( { color:0xfada00, side: THREE.DoubleSide } );
  ...
  var matSideWing = new THREE.MeshPhongMaterial({color:0xfada00, shading:THREE.FlatShading});
...
function loop(){
  ...
  }else if (game.status == "gamePaused"){}


  airplane.propeller.rotation.x +=0.6 + game.planeSpeed * deltaTime*.005;
  airplane.propeller1.rotation.x -=0.6 + game.planeSpeed * deltaTime*.005;
  ...
  requestAnimationFrame(loop, 1000, 30);
